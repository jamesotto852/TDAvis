...
needs to be pointing at a list column with `data.frame` elements.
...
See below how we plot barcode charts for each group in `df_group`:
...
```{r, results = FALSE, warning = FALSE, cache = TRUE}
library("patchwork")
set.seed(1)
